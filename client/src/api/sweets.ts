...
export const addSweet = (name: String, price: number, category: String, quantity: number) => sweetsAPI.post('/register', { name, price, category, quantity  });
...
export const searchSweets = (query: string) => sweetsAPI.get('/search', { params: { query } });